...
**Update March 2026:** Testcontainers is now used by multiple backend teams for integration testing with real database and message-broker instances. The reproducibility and speed improvements over shared test environments justify moving to Trial.
