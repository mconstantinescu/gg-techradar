...
Platforms like [Jaeger](/platforms-and-services/jaeger/) are suitable to monitor and analyze the collected information. Also [Prometheus](/platforms-and-services/prometheus/) supports ingesting data via the OpenTelemetry Protocol (OTLP).
