...
Gunvor Group utilizes Artifactory to serve Maven, Apt, npm, Composer and Docker Repositories.
...
Artifactory at Gunvor Group currently comes with some problems, too:
...
Gunvor Group is using the Professional version for a central instance that can be used by different teams.
