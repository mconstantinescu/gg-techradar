...
At Gunvor Group, we are using a monorepo that is home to both our React and Next.js based frontends and
...
and at Gunvor Group we have decided to go with [Nx](/tools/nx/).
