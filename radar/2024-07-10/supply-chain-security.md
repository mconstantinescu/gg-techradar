...
- Generate [Software Bills of Materials (SBOMs)](/platforms-and-services/sbom/) for transparency regarding used software dependencies and to support the automated detection of known vulnerabilities.
