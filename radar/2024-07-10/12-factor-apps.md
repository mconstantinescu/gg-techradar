...
1. **API First**: Design APIs first to ensure interoperability and future-proofing.
2. **Telemetry**: Implement robust telemetry for monitoring and diagnostics.
3. **Authentication and Authorization**: Incorporate strong, centralized authentication and authorization mechanisms.

## Relevance

For us, this rather old pattern is still very relevant, and many methods, patterns, and practices on our radar are related and enable these patterns at their core. To name a few, [Kubernetes](/platforms-and-services/kubernetes/), [Prometheus](/platforms-and-services/prometheus/), [Self-Service Infrastructure](/platforms-and-services/self-service-infrastructure/), or the [API-First Design Approach](/methods-and-patterns/api-first-design-approach/) are very related. Others, like [Shared Responsibility Models](/methods-and-patterns/shared-responsibility/), are easier to implement based on this pattern.
